...
class _$LoginResponseModelImpl implements _LoginResponseModel {
  const _$LoginResponseModelImpl(
      {this.status, this.email, this.uid, this.message, this.data, this.token});
  ...
  @override
  String toString() {
    return 'LoginResponseModel(status: $status, email: $email, uid: $uid, message: $message, data: $data, token: $token)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, status, email, uid, message, data, token);
...
abstract class _LoginResponseModel implements LoginResponseModel {
  const factory _LoginResponseModel(
      ...
      final String? message,
      final bool? data,
      final String? token}) = _$LoginResponseModelImpl;
