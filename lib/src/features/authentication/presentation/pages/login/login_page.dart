...
class LoginPage extends StatefulWidget {
  const LoginPage({super.key, this.canPop = true});
...
class _LoginPageState extends State<LoginPage> {
  ...
  getRememberMe() async {
    final response = await _storageHelper.getRememberMe;
    userNameRemember = await _storageHelper.getRememberMeUserName;
    if (response.isNotNullNotEmpty && response == 'true') {
      _rememberMe = true;
    }
    if ((response != null && response == 'true') && userNameRemember != null) {
      userNameController.text = userNameRemember!;
      if (userNameController.text.isNotNullNotEmpty) {
        WidgetsBinding.instance.addPostFrameCallback((timeStamp) {
          BlocProvider.of<LoginFormFieldCubit>(context)
              .onUserNameChanged(userNameRemember!);
        });
      }
    }
    setState(() {});
                        ...
                        children: [
                          Expanded(
                            child: Row(
                              ...
                              children: [
                                ...
                                Text(
                                  l10n.keepSignIn,
                                  style: context.orientation ==
                                      Orientation.portrait
                                      ? (sizingInformation.deviceScreenType ==
                                      DeviceScreenType.tablet
                                      ? AppStyles.text6PxRegular.whiteColor
                                      : AppStyles
                                      .text12PxRegular.whiteColor)
                                      : (sizingInformation.deviceScreenType ==
                                      DeviceScreenType.tablet
                                      ? AppStyles.text6PxRegular.whiteColor
                                      : AppStyles
                                      .text10PxRegular.whiteColor),
                                ),
                              ],
                            ),
                          ),
                          Text(
                            ...
                            style: context.orientation == Orientation.portrait
                                ? (sizingInformation.deviceScreenType ==
                                DeviceScreenType.tablet
                                ? AppStyles.text6PxRegular.blackColor
                                : AppStyles.text12PxRegular.blackColor)
                                : (sizingInformation.deviceScreenType ==
                                DeviceScreenType.tablet
                                ? AppStyles.text6PxRegular.blackColor
                                : AppStyles.text10PxRegular.blackColor),
                          )
                        ],
                      ),
                      context.orientation == Orientation.portrait
                              ...
                              child: BlocBuilder<LoginFormFieldCubit,
                                ...
                                builder: (context, state) {
                                  return CustomButton(
                                    ...
                                    width: context.width,
                                    isDisabled: false,
                                    loading: context.select<LoginCubit, bool>(
